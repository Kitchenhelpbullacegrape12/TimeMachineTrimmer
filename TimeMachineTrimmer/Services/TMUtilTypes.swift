...
func parseBackupStatus(_ output: String) -> BackupStatus {
...
func extractTMValue(from output: String, key: String) -> String? {
...
func parseErrorCode(_ output: String) -> String? {
    let patterns = [
        #"Error:\s*(-\d+)"#,
        #"\((-?\d+)\)"#
    ]
...
func parseBackupDate(from name: String) -> Date? {
    let patterns = [
